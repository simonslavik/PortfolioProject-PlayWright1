...
test('TC-02 - Login with invalid username', async ({ page }) => {
  ...
  await expect(page.getByText('Epic sadface: Username and do not match any user in this service')).toBeVisible();
});
...
test.afterEach(async ({ page }) => {
  // Clear username and password fields after each test
